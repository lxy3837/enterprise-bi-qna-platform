...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      title: 'Welcome',
      body: "Welcome to the Platform-Enabled Enterprise Intelligent Q&A Workbench. Built around natural-language data inquiry, it lets business users ask questions in plain language while a governed semantic layer, guarded SQL execution, visual dashboards, and anomaly insights run underneath — backed by organizational permissions and full audit trails.\n\nEvery query passes semantic validation, permission checks, and SQL safety constraints: read-only, explainable, and traceable. Configure a model service below to start asking.",
