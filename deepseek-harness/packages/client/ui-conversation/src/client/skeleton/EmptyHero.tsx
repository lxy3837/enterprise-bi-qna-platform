...
import {
  IconChevronDownOutline14, IconFolderClose16, IconFolderOpen16, WenMark,
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          <span className={css.heroMarkSeat}>
            {renderSlot(
              'conversation.hero.brand.mark',
              { size: 34, className: css.heroMark },
              { fallback: <WenMark size={34} className={css.heroMark} /> },
            )}
          </span>
